...
namespace XRF_Data_Analysis_Utilities.ViewModel.Workspaces
{
    public class XrfImageWorkspaceViewModel : WorkspaceViewModel, IXrfImageViewModel
    {
        ...
        // Workspace-Specific
        private ImageGraphViewModel _imageFrame;
        ...
        public ImageGraphViewModel ImageFrame
        {
            get
            {
                return _imageFrame;
        ...
        public XrfImageWorkspaceViewModel(string _elementName, pixel[][] _data)
        {
            ...
            ImageFrame = new ImageGraphViewModel(_defaultImageSize, (x) => LeftMouseClickAction(x), (y) => RightMouseClickAction(y), (temp, mr, mg, mb) => ColorFillAction(temp, mr, mg, mb));
